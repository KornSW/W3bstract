...
''' <summary>
''' returns a response containing a java-script which registers a json-serialized
''' representation of the given .net object into the browser window
''' ('window.{ObjectName} = {ObjectToStrap}')
''' </summary>
